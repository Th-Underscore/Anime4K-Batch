...
REG ADD "%ROOT_STORE%\Ani4K.Transcode\command" /ve /d "\"%SCRIPT_DIR%\Anime4K-Batch.bat\" \"%%1\"" /f
...
REG ADD "%ROOT_STORE%\Ani4K.Transcode" /v Icon /t REG_SZ /d "%SCRIPT_DIR%\assets\icons\Transcode_32.ico" /f

REM Ani4K.Extract (File)
REG ADD "%ROOT_STORE%\Ani4K.Extract\command" /ve /d "\"%SCRIPT_DIR%\extract-subs.bat\" \"%%1\"" /f
REG ADD "%ROOT_STORE%\Ani4K.Extract" /v MUIVerb /t REG_SZ /d "Extract subtitles" /f
REG ADD "%ROOT_STORE%\Ani4K.Extract" /v Icon /t REG_SZ /d "%SCRIPT_DIR%\assets\icons\Extract_32.ico" /f

REM Ani4K.Remux (File)
REG ADD "%ROOT_STORE%\Ani4K.Remux\command" /ve /d "\"%SCRIPT_DIR%\remux.bat\" \"%%1\"" /f
REG ADD "%ROOT_STORE%\Ani4K.Remux" /v MUIVerb /t REG_SZ /d "Remux" /f
REG ADD "%ROOT_STORE%\Ani4K.Remux" /v Icon /t REG_SZ /d "%SCRIPT_DIR%\assets\icons\Remux_32.ico" /f
...
REG ADD "%ROOT_STORE%\Ani4K.TranscodeDir" /v Icon /t REG_SZ /d "%SCRIPT_DIR%\assets\icons\TranscodeDir_32.ico" /f
REG ADD "%ROOT_STORE%\Ani4K.ExtractDir" /v Icon /t REG_SZ /d "%SCRIPT_DIR%\assets\icons\ExtractDir_32.ico" /f
REG ADD "%ROOT_STORE%\Ani4K.RemuxDir" /v Icon /t REG_SZ /d "%SCRIPT_DIR%\assets\icons\RemuxDir_32.ico" /f
...
REG ADD "%ROOT_CLASS%\*\shell\Anime4K-Batch" /v Icon /t REG_SZ /d "%SCRIPT_DIR%\assets\icons\cmd_16.ico" /f
...
REG ADD "%ROOT_CLASS%\Directory\shell\Anime4K-Batch" /v Icon /t REG_SZ /d "%SCRIPT_DIR%\assets\icons\cmdDir_32.ico" /f
