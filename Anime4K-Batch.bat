...
::   -set-subs-priority : Set default subtitle track on the *input* file using set-subs-priority.bat
...
::    - call "%~dp0\scripts\glsl-transcode.bat" -w 3840 -h 2160 -shaderpath "%appdata%\mpv\shaders" -shader Anime4K_ModeA_A.glsl -r -f -extract-subs -set-audio-priority -alang "jpn,rus,eng" -atitle "Commentary" %* ^
::
